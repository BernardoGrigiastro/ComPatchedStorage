...
public class TileEntityBarrelFluidRenderer extends TileEntityRenderer<TileEntityBarrelFluid> {
	...
	public TileEntityBarrelFluidRenderer(TileEntityRendererDispatcher terd) {
		super(terd);
	}
	...
	@Override
	public void render(TileEntityBarrelFluid p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
