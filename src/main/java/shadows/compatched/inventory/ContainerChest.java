...
public class ContainerChest extends Container {
	...
	public ContainerChest(int id, World world, ICompatchedInventory chest, PlayerEntity player, BlockPos pos) {
	...
	public static ICompatchedInventory readChest(PacketBuffer buf, PlayerInventory inv) {
		boolean chest = buf.readBoolean();
		if (chest) return (ICompatchedInventory) inv.player.world.getTileEntity(buf.readBlockPos());
		else {
	...
	public static PacketBuffer writeChest(PacketBuffer buf, ICompatchedInventory chest) {
		buf.writeBoolean(chest instanceof CompatchedChestTileEntity);
		if (chest instanceof CompatchedChestTileEntity) buf.writeBlockPos(((CompatchedChestTileEntity) chest).getPos());
